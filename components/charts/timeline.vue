<template>
  <div>
    <div style="    top: 185px;" id="chartdiv"></div>
  </div>
</template>
<script>
import {
  ...
  methods: {
    loadChart() {
      ...
      am4core.ready(function() {
        var chart = am4core.create("chartdiv", timeline.CurveChart);
        ...
        dateAxis.min = new Date(2010, 0).getTime();
        dateAxis.max = new Date(2022, 0).getTime();
        // dateAxis.min = 1985;
        // dateAxis.max = 2019;
        ...
        var series = chart.series.push(new timeline.CurveColumnSeries());
        ...
        var imageBullet1 = series.bullets.push(new bullets.PinBullet());
        ...
        var cursor = new timeline.CurveCursor();
        chart.cursor = cursor;
